...
<table>
  ...
  <tbody>
    ...
    if(typeof(item.feature) === "boolean" && item.feature === true && props.relatedItemFeatures[index].feature === true) {
      return(
      <tr>
        <td><AiOutlineCheck /></td>
        <td><AiOutlineCheck />{item.feature}</td>
        <td><AiOutlineCheck /></td>
      </tr>
      )
    }else {
...
// return (
//   <>
//   <div className = "showModal">Hello Modal <button onClick = {onClose}>close</button> </div>
